  ...
  data () {
    return {
      ...
      menu: [
        ...
        {path: '/api/docente', label: 'Docentes', icon: 'list'},
        {path: '/api/aula', label: 'Aulas', icon: 'class'},
        {path: '/api/materia', label: 'Materias', icon: 'description'},
        {path: '/api/horario', label: 'Horarios', icon: 'event'},
